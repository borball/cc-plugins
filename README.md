...
| Plugin                        | Version | Released   | Description |
|-------------------------------|---------|------------|-------------|
| [rh-case](plugins/rh-case/) | 0.3.0 | 2026-04-08 | Red Hat support case management — list, show, search, analyze, and comment on cases |
| [jira](plugins/jira/) | 0.3.0 | 2026-04-23 | Jira integration — pick tickets, track time, post work logs, update descriptions, and manage status |
| [slack](plugins/slack/) | 0.4.0 | 2026-04-07 | Read, search, and send Slack messages — search conversations, read channels, follow threads, send messages |
| [report](plugins/report/) | 0.3.0 | 2026-04-22 | Generate activity reports from git and Jira — daily standups, weekly/bi-weekly summaries, compact HTML |
