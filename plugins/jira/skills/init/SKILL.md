...
- **Global** (default) — saves to the plugin data directory, shared across all projects
...
1. **JIRA_URL** — Atlassian URL (default: https://redhat.atlassian.net)
...
```bash
CLAUDE_PLUGIN_DATA="${CLAUDE_PLUGIN_DATA}" ${CLAUDE_PLUGIN_ROOT}/scripts/jira-pick.sh
```
